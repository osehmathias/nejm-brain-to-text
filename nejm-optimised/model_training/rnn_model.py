...
class GRUDecoder(nn.Module):
    ...
    def forward(self, x, day_idx, states = None, return_state = False, return_hidden = False):
        '''
        ...
        return_state (bool) - if True, return the final hidden state
        return_hidden (bool) - if True, return per-timestep hidden states (GRU output)
        '''
        ...
        if return_state and return_hidden:
            return logits, hidden_states, output
        elif return_state:
