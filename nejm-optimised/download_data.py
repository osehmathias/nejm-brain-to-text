...
def main():
    ...
    assert os.getcwd().endswith("nejm-brain-to-text") or os.getcwd().endswith("nejm-optimised"), \
        f"Please run the download command from the nejm-brain-to-text or nejm-optimised directory (instead of {os.getcwd()})"
